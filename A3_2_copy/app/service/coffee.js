    ...
    <ScrollView>
      ...
      <View style={styles.definition_container}>
        ...
        <Text style={styles.definition_txt}>
          A drink made by infusion or decoction from the seeds of a shrub,
          roasted and ground or pounded; extensively used as a beverage, and
          acting as a moderate stimulant.
        </Text>
      </View>
    </ScrollView>
  );
