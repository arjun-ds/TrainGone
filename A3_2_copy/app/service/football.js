    ...
    <ScrollView>
      ...
      <View style={styles.definition_container}>
        ...
        <Text style={styles.definition_txt}>
          A sport originating in the United States, based on rugby football and
          played by two teams of eleven players on a field marked out in the
          form of a gridiron, points being scored from touchdowns and field
          goals.
        </Text>
      </View>
    </ScrollView>
